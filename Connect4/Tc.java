...
public class Tc {
     ...
     */
    public Tc(String serverAddress) throws Exception {
        ...
        try {
            ...
            while (true) {
                ...
                if (response.startsWith("VALID_MOVE")) {
					...
					JOptionPane.showMessageDialog(null , "Wins : "+ win + " Losses : "+ loss + "Tie: " +  tie );
					...
					JOptionPane.showMessageDialog(null , "Wins : "+ win + " Losses : "+ loss + "Tie: " +  tie );messageLabel.setText("You tied");
                    tie++;
					break;
    ...
    public static void main(String[] args) throws Exception {
        while (true) {
            ...
            Tc client = new Tc(serverAddress);
            client.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            client.frame.setSize(400, 400);
            client.frame.setVisible(true);
			client.frame.setBackground(Color.CYAN);
