...
public class C4C {
	...
	private static int win = 0,loss=0,tie= 0;    /**
     * Constructs the client by connecting to a server, laying out the
     * GUI and registering GUI listeners.
     */
    public C4C(String serverAddress) throws Exception {
        ...
        try {
            ...
            while (true) {
                ...
                if (response.startsWith("VALID_MOVE")) {
                    ...
                    win++;
					messageLabel.setText("You win win :" + win + " Losses " + loss+ " tie " + tie);
                    break;
                } else if (response.startsWith("DEFEAT")) {
                    loss++;
					messageLabel.setText("You lose win :" + win + " Losses " + loss+ " tie " + tie);
                    break;
                } else if (response.startsWith("TIE")) {
                    tie++;
					messageLabel.setText("You tied win :" + win + " Losses " + loss+ " tie " + tie);
                    break;
    ...
    public static void main(String[] args) throws Exception {
        while (true) {
            ...
            C4C client= new C4C(serverAddress);
