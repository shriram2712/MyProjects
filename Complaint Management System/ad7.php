...
{
        $sql1 = "INSERT INTO complaint3_2 select * from complaint3_3 LIMIT 1;";
...
{
        $sql1 = "INSERT INTO del3 select * from complaint3_3 LIMIT 1;";
if(mysqli_query($link, $sql1)){
...
$sql="DELETE FROM complaint3_3 LIMIT 1";
