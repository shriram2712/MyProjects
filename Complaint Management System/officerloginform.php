<?php
	...
	if(isset($_POST['username']) && isset($_POST['password']))
	{
		...
		{
			$query = "SELECT id FROM officers WHERE username = '$username' AND password = '$password_hash';";
...
<h2 style="text-align:center">Welcome Officer!</h2>
<h3 style="text-align:center">Please Log in to review complaints at your desk </h3><br>

<!--Login form with username and password-->
<form action = "officerloginform.php" method = "POST">
