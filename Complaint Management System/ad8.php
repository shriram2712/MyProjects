...
{
        $sql1 = "INSERT INTO complaint3_1 select * from complaint3_2 LIMIT 1;";
...
{
        $sql1 = "INSERT INTO del2 select * from complaint3_2 LIMIT 1;";
if(mysqli_query($link, $sql1)){
...
$sql="DELETE FROM complaint3_2 LIMIT 1";
