...
<form method="post" action="view4.php">
<?php
...
{
        $sql1 = "INSERT INTO complaint2_2 select * from complaint2_3 LIMIT 1;";
if(mysqli_query($link, $sql1)){
    echo "<br><br><h4 style='text-align:center'>Complaint passed to desk 2</h4>";
} else{
...
{
        $sql1 = "INSERT INTO del3 select * from complaint2_3 LIMIT 1;";
if(mysqli_query($link, $sql1)){
...
$sql="DELETE FROM complaint2_3 LIMIT 1";
