...
{
        $sql1 = "INSERT INTO complaint1_1 select * from complaint1_2 LIMIT 1;";
...
{
        $sql1 = "INSERT INTO del2 select * from complaint1_2 LIMIT 1;";
if(mysqli_query($link, $sql1)){
...
$sql="DELETE FROM complaint1_2 LIMIT 1";
