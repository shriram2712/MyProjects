...
<form method="post" action="view5.php">
<?php
...
{
        $sql1 = "INSERT INTO complaint2_1 select * from complaint2_2 LIMIT 1;";
if(mysqli_query($link, $sql1)){
    echo "<br><br><h4 style='text-align:center'>Complaint passed to desk 1</h4>";
} else{
...
{
        $sql1 = "INSERT INTO del2 select * from complaint2_2 LIMIT 1;";
if(mysqli_query($link, $sql1)){
...
$sql="DELETE FROM complaint2_2 LIMIT 1";
